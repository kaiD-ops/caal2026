...
build/exe/test_d_model_32.exe:     file format elf32-littleriscv
...
80000004:	50010113          	addi	sp,sp,1280 # f0040500 <_stack_start>
80000008:	70040417          	auipc	s0,0x70040
8000000c:	3f840413          	addi	s0,s0,1016 # f0040400 <h_real>
80000010:	70040497          	auipc	s1,0x70040
80000014:	47048493          	addi	s1,s1,1136 # f0040480 <h_imag>
80000018:	4281                	c.li	t0,0

8000001a <init_loop>:
8000001a:	02000313          	addi	t1,zero,32
...
80000044:	02000a93          	addi	s5,zero,32

80000048 <d_loop>:
80000048:	0f5a5f63          	bge	s4,s5,80000146 <d_done>
8000004c:	70040297          	auipc	t0,0x70040
80000050:	0b428293          	addi	t0,t0,180 # f0040100 <test_A_real>
...
80000064:	12028293          	addi	t0,t0,288 # f0040180 <test_A_imag>
...
800000c8:	02000e13          	addi	t3,zero,32
...
800000fe:	10628293          	addi	t0,t0,262 # f0040200 <test_C_real>
80000102:	006283b3          	add	t2,t0,t1
80000106:	0003a207          	flw	ft4,0(t2)
8000010a:	70040297          	auipc	t0,0x70040
8000010e:	17628293          	addi	t0,t0,374 # f0040280 <test_C_imag>
...
80000130:	1d428293          	addi	t0,t0,468 # f0040300 <test_output>
