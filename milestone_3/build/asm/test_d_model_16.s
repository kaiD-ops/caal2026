...
build/exe/test_d_model_16.exe:     file format elf32-littleriscv
...
80000004:	28010113          	addi	sp,sp,640 # f0040280 <_stack_start>
80000008:	70040417          	auipc	s0,0x70040
8000000c:	1f840413          	addi	s0,s0,504 # f0040200 <h_real>
80000010:	70040497          	auipc	s1,0x70040
80000014:	23048493          	addi	s1,s1,560 # f0040240 <h_imag>
80000018:	4281                	c.li	t0,0

8000001a <init_loop>:
8000001a:	4341                	c.li	t1,16
...
80000060:	06428293          	addi	t0,t0,100 # f00400c0 <test_A_imag>
...
800000f8:	00c28293          	addi	t0,t0,12 # f0040100 <test_C_real>
800000fc:	006283b3          	add	t2,t0,t1
80000100:	0003a207          	flw	ft4,0(t2)
80000104:	70040297          	auipc	t0,0x70040
80000108:	03c28293          	addi	t0,t0,60 # f0040140 <test_C_imag>
...
8000012a:	05a28293          	addi	t0,t0,90 # f0040180 <test_output>
