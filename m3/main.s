...
_start:
    ...
    # Step 1:hilbert_scan(hilbert_indices, img, buf_hilbert)
    ...
    # Step 2: UProject linear layer  [4096,1] -> [4096,64]  linear_layer(W, b, in, out, in_dim=1, out_dim=64, seq_len=4096)
    ...
    # Step 3:  s4d_layer(log_dt, log_A_real, A_imag, C_mat, D_vec, in, out)
    ...
    # Step 8: FC head  [64] -> [4] linear_layer(fc_weight, fc_bias, pooled, logits, 64, 4, 1)
